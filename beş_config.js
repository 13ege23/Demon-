module.exports = {
    ...
    token: "MTE0MzEzNTM3MjA3NTg2NDExNg.GBA6Iq.ibVe59QkJ_ZBCghvy2-K4ur_c1vwLJtKTg1muc", //Bot Tokeniniz => Bot Oluşturduktan Sonra Intentsleri Açmayı Unutma!
    guildID: "1137540480050151536", //Kullanıcağın Sunucunun ID'si
    voiceChannelID: "1137540844270923776", // Ses Kanal ID'si
    presence: "miyu ege ye aşık", //Botun Durumu
    footer: "Beş & Luppux", //Embedların Footer Yazısı
    botOwners: ["1091415573990219806"], //Bot Sahibinin ID'si
    ...
    selamVer:true, // Kayıt Olduktan Sonra Chat kanalında Butonla Selam Verme Sistemi


    //Eğer Buraya Kadar Yaptıysan .setup Komudunu Kullanarak Botu Sunucuna Kurmaya Başla.
    mongoURL: "mongodb+srv://yildiray356basran:Deneme3@cluster0.dtxskjr.mongodb.net/?retryWrites=true&w=majority", //MongoDB URL'niz
    ...
    staffs: ["1137540821831405598,1140296666868621383,1140296985430216765"], // Yetkililerin Rol ID'leri ["55555","55555"] Şeklinde Girilir

    parents: { // Kategorilerin ID'leri ["55555","55555"] Şeklinde Çoklu Girilebilir
        publicParents: ["1132409493465088000"],
        registerParents: ["1132409493465088000"],
        solvingParents: ["1132409493465088000"],
        privateParents: ["1132409493465088000"],
        aloneParents: ["1132409493465088000"],
        funParents: ["1132409493465088000"]
    },
